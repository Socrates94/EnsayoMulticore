// Compilacion: icpx -g -O3 -march=native -fno-inline -qopt-report=max -qopt-report-phase=vec -o explicit KernelExplicit.cpp
...
int main() {
    ...
    sobel_explicit_avx2(Gx, Gy, Mag, TOTAL_SIZE);
