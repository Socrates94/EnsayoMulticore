...
\begin{itemize}
    \item \textbf{Procesador (CPU):} AMD Ryzen 9 5900X (24 hilos lógicos a 4.95 GHz). Arquitectura de 64 bits de alto rendimiento con soporte nativo para el conjunto de instrucciones de extensiones vectoriales avanzadas (AVX y AVX2).
