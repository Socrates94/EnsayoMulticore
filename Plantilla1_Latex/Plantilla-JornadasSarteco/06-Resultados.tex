...
El reporte de Intel Advisor confirmó la correcta generación de instrucciones SIMD para las versiones optimizadas. Sin embargo, la métrica de GFLOPS (\textit{Giga Flops Per Second}) varió drásticamente dependiendo de la intervención manual del programador frente a las decisiones autónomas del compilador.
